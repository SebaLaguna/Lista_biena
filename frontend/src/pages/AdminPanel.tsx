...
type Tab = 'reservations' | 'users' | 'locations' | 'cabins' | 'blocked_dates' | 'logs';
        ...
        <div className="w-full space-y-8 md:space-y-10 py-4 md:py-8 px-4 sm:px-6 lg:px-10">
            ...
            <div className="flex flex-wrap gap-2 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-3 rounded-t-lg font-black text-[10px] uppercase tracking-widest transition-all ${activeTab === 'reservations' ? 'bg-armada-navy text-armada-gold shadow-lg transform -translate-y-1' : 'bg-slate-200 text-slate-500 hover:bg-slate-300'
                        }`}
                >
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-3 rounded-t-lg font-black text-[10px] uppercase tracking-widest transition-all ${activeTab === 'users' ? 'bg-armada-navy text-armada-gold shadow-lg transform -translate-y-1' : 'bg-slate-200 text-slate-500 hover:bg-slate-300'
                        }`}
                >
